            ...
            <Container className="about-container" fluid="md">
                <Row>
                    ...
                    <Col md={8} className="about-body">
                        ...
                        <p className="about-text">Founded in 2020 by Coachella Valley local John “Rocky” Rockwell alongside his son with the goal of offering professional level service and craftsmanship to our customers. Rocky comes from a lengthy background in Heavy Metal under his band “Tyrant” which he helped form in the late 70s. Rocky has designed, built and maintained his own guitars for many years and began offering his services as a Repair Tech in 2014.</p>
